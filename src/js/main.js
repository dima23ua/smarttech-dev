...
function popupOpen(curentPopup) {
   if (curentPopup && unlock) {
      const popupActive = document.querySelector('.signin.open');
      if (popupActive) {
      ...
      curentPopup.addEventListener("click", function (e) {
         if (!e.target.closest('.signin__content')) {
            popupClose(e.target.closest('.signin'));
         }
      });
   }
}
